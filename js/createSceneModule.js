...
function createScene() {
  if (map==0){
    ...
    createBazzi(-7, -6)
    if(easyToHard == 'middle' || easyToHard == 'hard') createBazzi(-6, 5)
    if(easyToHard == 'hard') createBazzi(6, -5)
  } else if (map==1) {
    initfactory()
    for(let now=0; now<195; now++){
    ...
    createBazzi(-6, -6)
    if(easyToHard == 'middle' || easyToHard == 'hard') createBazzi(-6, 6)
    if(easyToHard == 'hard') createBazzi(6, -6)
  }
  createWall(0, 1)
  createWall(0, -1)
  createWall(1, 1)
