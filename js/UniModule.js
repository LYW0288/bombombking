...
class Uni {
  constructor(scale_) {
    ...
    const handGeo = new THREE.BoxGeometry(0.07*scale_, 0.16*scale_, 0.07*scale_)
    ...
    const footGeo = new THREE.BoxGeometry(0.1*scale_, 0.09*scale_, 0.1*scale_)

    const textureLoader = new THREE.TextureLoader()
    const headMap = textureLoader.load('./img/uniface.png')
    const skinMap = textureLoader.load('./img/unibelly.png')
    const normalMap = textureLoader.load('./img/uninormal.png')
    const normalMap2 = textureLoader.load('./img/uninormal2.png')
    const normalMat = new THREE.MeshPhongMaterial({ color: 0x77DA20 })
    ...
    this.head.position.set(0, 0.13*scale_, 0)

    this.body = new THREE.Mesh(bodyGeo, skinMaterials)
    this.body.position.set(0, -0.16*scale_, 0)

    this.ear1 = new THREE.Mesh(earGeo, white)
    this.ear1.position.set(0.2*scale_, 0.4*scale_, -0.17*scale_)
    this.ear2 = this.ear1.clone()
    this.ear2.position.set(-0.2*scale_, 0.4*scale_, -0.17*scale_)

    this.hand1 = new THREE.Mesh(handGeo, skinMat)
    this.hand1.position.set(-0.17*scale_, -0.13*scale_, 0)
    this.hand2 = this.hand1.clone()
    this.hand2.position.set(0.17*scale_, -0.13*scale_, 0)
    ...
    this.down1.position.set(0.055*scale_, -0.345*scale_, 0)
    this.down2 = this.down1.clone()
    this.down2.position.set(-0.055*scale_, -0.345*scale_, 0)
    this.down3 = new THREE.Mesh(toeGeo, normalMat)
    this.down3.position.set(0.055*scale_, -0.375*scale_, 0)
    this.down4 = this.down3.clone()
    this.down4.position.set(-0.055*scale_, -0.375*scale_, 0)
